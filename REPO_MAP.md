...
|---|---|---|
| Python files under `src/` | 1042 | `find src -name '*.py' \| wc -l` |
| Python files under `tests/` | 1105 | `find tests -name '*.py' \| wc -l` |
...
| Files using `@keras.saving.register_keras_serializable` | 482 | `grep -rl "@keras.saving.register_keras_serializable" src/dl_techniques --include=*.py \| wc -l` |
| Files defining `get_config` | 483 | `grep -rl "def get_config" src/dl_techniques --include=*.py \| wc -l` |
| Files using the central logger | 343 | `grep -rl "utils.logger" src/dl_techniques --include=*.py \| wc -l` |
...
| Library modules using Sphinx `:param` OUTSIDE `src/dl_techniques/layers/attention/` | 368 | `grep -rl ":param " src/dl_techniques --include=*.py \| grep -vc "src/dl_techniques/layers/attention"` |
