...
def get_special_token_ids(
    ...
    # DECISION plan-2026-08-25T165753-704a9bcb/D-010
    ...
    # is a behavioural change to a shared util, not a comment fix. Documented
    # rather than changed -- see decisions.md D-010.
    special_tokens = {
