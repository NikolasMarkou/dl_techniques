"""
Enhanced Metrics module for WeightWatcher
...
def calculate_concentration_metrics(
    ...
    """
    if min(weight_matrix.shape) < DEFAULT_MIN_EVALS:
        return {}
    ...
    concentration_score = gini * dominance / (np.mean(participation_ratios) + EPSILON)
