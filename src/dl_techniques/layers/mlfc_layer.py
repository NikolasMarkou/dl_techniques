"""
Multi Level Feature Compilation (MLFC) Implementation.

This module implements the MLFC layer from ACC-UNet, which aggregates features
from multiple encoder levels by resizing them to common dimensions, concatenating,
and processing through pointwise convolutions with residual connections.
"""
