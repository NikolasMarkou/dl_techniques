...
class BiasFreeConv2D(keras.layers.Layer):
    ...
    and better generalization across noise levels in image denoising tasks.
    ...
    :type filters: int
    :param kernel_size: Size of the convolutional kernel. Integer for square
        kernels or tuple of 2 integers for asymmetric kernels. Defaults to 3.
    ...
    def get_config(self) -> Dict[str, Any]:
        ...
        config.update({
            ...
            # DECISION plan-2026-09-15T034909-a7edc8da/D-008
...
class BiasFreeResidualBlock(keras.layers.Layer):
    ...
    def compute_output_shape(self, input_shape: Tuple[Optional[int], ...]) -> Tuple[Optional[int], ...]:
        ...
        :param input_shape: Shape of the input.
        :type input_shape: Tuple[Optional[int], ...]
        :return: Output shape tuple with updated channel dimension.
        :rtype: Tuple[Optional[int], ...]
        """
