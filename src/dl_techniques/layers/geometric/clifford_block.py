...
6. ``@keras.saving.register_keras_serializable()`` is intentionally left without
   ...
   SUPERSEDED 2026-08-29 (the registration migration).
   ...
   key.  The alias is load-bearing, not decorative: the measured control is that
   an archive written under ``Custom>X`` and reloaded after the re-key
