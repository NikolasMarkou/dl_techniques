...
class MushroomBodyLayer(keras.layers.Layer):
    ...
    **Architecture Overview:**
    ...
    def call(
        ...
        # DECISION plan_2026-06-15_00924f53/D-003: keras.ops has scatter_update (inputs,indices,updates),
        # NOT scatter_nd_update, in Keras 3.8; functional scatter-into-zeros (WTA top-k), indices already (B*k,2).
