...
| stochastic depth (upstream ships none; the knob is ours) | `StochasticDepth` + `linear_drop_path_rates` | `dl_techniques.layers.stochastic_depth`, `dl_techniques.utils.drop_path` | Off by default; see §4.7 |
