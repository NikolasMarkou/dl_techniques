"""Ideogram4 sequence-packing and conditioning constants.

Ported verbatim from the PyTorch reference ``src/ideogram4/constants.py``.
These integer sentinels mark padding/image/text tokens in the packed
self-attention stream and offset image grid coordinates so they never
collide with text token indices.
"""
