...
def run_segmentation_finetuning(
    ...
    # Configure loss for Deep Supervision with SIGMOID
    if convunext_model.enable_deep_supervision:
        ...
        # CRITICAL: Use binary_crossentropy for sigmoid activation
        ...
        logger.info(f"Loss: binary_crossentropy (multi-label)")
        logger.info(f"Loss weights: {loss_weights}")
        ...
        # CRITICAL: Use binary_crossentropy for sigmoid
