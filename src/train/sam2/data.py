...
-------------------------
The three target keys come from ``models/vision_language/sam/sam2/training_model.py``'s exported
...
def to_video_training_record(
    ...
    # THREE target keys, each sourced from `models/vision_language/sam/sam2/training_model.py`'s
...
def build_sam2_video_dataset(
    ...
    # FIRST `fit()` step, from inside `models/vision_language/sam/sam2/model.py`, which this
