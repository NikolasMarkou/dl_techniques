...
from dl_techniques.models.convnext import ConvNeXtV1, create_convnext_v1
...
def train_model(args: argparse.Namespace):
    ...
    logger.info("Starting ConvNeXt V1 training script")
    setup_gpu()
    ...
    # Build the model - should work now
    try:
    ...
    if hasattr(model, 'summary'):
        try:
            logger.info("ConvNeXt adaptive model details:")
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description='Train a ConvNeXt V1 model.')
