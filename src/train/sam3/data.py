...
``models/vision_language/sam/sam3/training_model.py``'s ``pack_targets``, so no channel index is
spelled here either.
"""
...
from dl_techniques.models.vision_language.sam.sam3.training_model import pack_targets
...
def build_sam3_dataset(
    ...
    Args:
        model: A built or unbuilt
            :class:`~dl_techniques.models.vision_language.sam.sam3.training_model.Sam3TrainingModel`.
        num_samples: Records in one epoch.
