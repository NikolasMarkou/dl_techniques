...
- SRIP (Spectral Restricted Isometry Property) Regularizer
...
from dl_techniques.regularizers.binary_preference import get_binary_regularizer
...
class RegularizerExperiment:
    ...
    def _setup_regularizers(self) -> Dict[str, Optional[keras.regularizers.Regularizer]]:
        ...
        return {
            ...
            'binary_4.0': get_binary_regularizer(multiplier=self.config.regularizer_multiplier, scale=4.0),
            'binary_8.0': get_binary_regularizer(multiplier=self.config.regularizer_multiplier, scale=8.0),
        }
