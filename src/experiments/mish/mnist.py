...
- 10,000 test images
- Standard preprocessing with normalization and light augmentation
...
class ExperimentConfig:
    ...
    use_rgb: bool = False  # Keep MNIST in grayscale (1 channel)
    ...
    experiment_name: str = "mnist_activation_comparison"
    random_seed: int = 42
...
def run_experiment(config: ExperimentConfig) -> Dict[str, Any]:
    ...
    for name, model in trained_models.items():
        ...
        # Calculate top-5 accuracy (for MNIST, top-5 is less meaningful but included)
