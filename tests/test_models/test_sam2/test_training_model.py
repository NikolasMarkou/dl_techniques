...
from dl_techniques.models.vision_language.sam.sam2.model import NO_OBJ_SCORE, SAM2, create_sam2
...
class TestFrameZeroTakesADifferentPath:
    ...
    def test_the_documented_empty_memory_fallback_is_unreachable(self) -> None:
        """A LATENT DEFECT in ``models/vision_language/sam/sam2/model.py``, measured here.
        ...
        (``models/vision_language/sam/sam2/``'s eight pre-existing modules stay byte-unchanged), so
