...
from dl_techniques.models.vision_language.sam.sam2.hiera import (
    Hiera,
    HieraBlock,
...
def _capture_attention_shapes(
    ...
    """
    import dl_techniques.models.vision_language.sam.sam2.hiera as hiera_module
...
class TestVariantTableIsTheSingleHome:
    ...
    def test_tiny_is_defined_only_in_model_variants(self) -> None:
        ...
        import inspect
        import dl_techniques.models.vision_language.sam.sam2 as package
