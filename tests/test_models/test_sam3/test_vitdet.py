"""Tests for SAM 3's ViTDet trunk (`models/vision_language/sam/sam3/vitdet.py`).
...
from dl_techniques.models.vision_language.sam.sam3.vitdet import (
    Sam3ViTDetBackbone,
    Sam3ViTDetBlock,
    _window_partition,
    _window_unpartition,
...
class TestPurity:
    def test_library_file_uses_no_tensorflow(self):
        ...
        from dl_techniques.models.vision_language.sam.sam3 import vitdet
