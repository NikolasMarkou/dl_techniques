"""
Tests for ``models/vision_language/sam/sam3/sam3_image.py`` -- the top-level ``Sam3Image`` assembly.
...
from dl_techniques.models.vision_language.sam.sam3.sam3_image import COMPONENT_KEYS
...
class TestConstruction:
    ...
    def test_the_public_class_surface_is_exactly_the_declared_eleven(self):
        ...
        import dl_techniques.models.vision_language.sam.sam3 as package
    ...
    def test_the_tiny_variant_is_declared_not_a_published_size(self):
        ...
        import dl_techniques.models.vision_language.sam.sam3.sam3_image as module
    ...
    def test_a_width_mismatch_is_refused(self):
        from dl_techniques.models.vision_language.sam.sam3 import Sam3DotProductScoring
...
class TestPresenceSource:
    ...
    def test_a_decoder_without_a_presence_token_is_refused(self):
        from dl_techniques.models.vision_language.sam.sam3 import Sam3TransformerDecoder
        parts = Sam3Image.from_variant("tiny")
    ...
    def test_the_final_box_is_the_last_layers_refinement(self, model, batch):
        ...
        hidden, anchors, _, _ = model.transformer(
            ...
            memory_pos=model._flatten(
                model._scalped(neck_out["sam3_pos"])[-1]),
            training=False)
        from dl_techniques.models.vision_language.sam.sam3 import Sam3TransformerDecoder as Dec
