"""Tests for SAM 3's dual SimpleFPN neck (`models/vision_language/sam/sam3/necks.py`).
...
from dl_techniques.models.vision_language.sam.sam3.necks import (
    SUPPORTED_SCALES,
    Sam3DualViTDetNeck,
    _build_scale_stack,
    _encode_position,
...
class TestPurity:
    def test_library_file_uses_no_tensorflow(self):
        import dl_techniques.models.vision_language.sam.sam3.necks as module
