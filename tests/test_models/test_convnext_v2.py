"""Tests for ConvNeXt V2 model implementations."""
...
from dl_techniques.models.convnext_v2 import (
    ConvNextV2,
    ConvNextV2Atto,
    ConvNextV2Femto,
    ConvNextV2Pico,
...
class TestConvNextV2:
    """Test cases for ConvNeXt V2 models."""

    @pytest.mark.parametrize(
        "model_fn,expected_shape",
        [
            (ConvNextV2Atto, (None, 1000)),
            (ConvNextV2Femto, (None, 1000)),
            (ConvNextV2Pico, (None, 1000)),
            (ConvNextV2Nano, (None, 1000)),
            (ConvNextV2Tiny, (None, 1000)),
        ],
    )
    ...
    @pytest.mark.parametrize(
        "model_fn,expected_shape",
        [
            (ConvNextV2Atto, (None, 320)),
            (ConvNextV2Femto, (None, 384)),
            (ConvNextV2Pico, (None, 512)),
            (ConvNextV2Nano, (None, 640)),
            (ConvNextV2Tiny, (None, 768)),
        ],
    )
