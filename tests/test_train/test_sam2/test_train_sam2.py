...
# MEASURED 2026-08-23: fires in 4 of the 87 tests here, all in
# `TestTheTrainersOwnFactoriesTrain::test_the_pipeline_and_the_model_agree_on_every_axis`.
...
class TestConfigValidation:
    ...
    def test_the_mask_grid_matches_what_the_model_emits(self) -> None:
        ...
        """
        from dl_techniques.models.vision_language.sam.sam2.model import MEMORY_STRIDE
...
class TestTheBatchAxisIsStatic:
    ...
    ``fit()`` step, from inside ``models/vision_language/sam/sam2/model.py``, which this iteration
