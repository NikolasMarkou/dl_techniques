...
the tests of `src/dl_techniques/models/mobile_clip_v2/` have a **real** oracle instead of a second
...
- `tests/test_models/test_mobile_clip_v2/test_image_encoder.py::TestVariantTable::test_mci3_mci4_match_supplied_source`
  parses `mobileclip2.py` and checks `MCI_VARIANTS['mci3']` / `['mci4']`.
- `tests/test_models/test_mobile_clip_v2/test_model.py::TestVariantTable::test_model_variants_match_supplied_json_configs`
...
`src/dl_techniques/models/mobile_clip_v2/README.md`.
