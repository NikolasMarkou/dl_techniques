...
\item
  \hyperref[how-to-read-this-guide]{How to Read This Guide}
\item
  \hyperref[notation-and-conventions]{Notation and Conventions}
\item
  \hyperref[prerequisites-primer]{Prerequisites Primer}

  \begin{itemize}
  \tightlist
  \item
    \hyperref[p1-random-variables-expectations-and-moments]{P1. Random
    variables, expectations, and moments}
  \item
    \hyperref[p2-entropy-cross-entropy-kl-divergence]{P2. Entropy,
    cross-entropy, KL divergence}
  \item
    \hyperref[p3-characteristic-functions]{P3. Characteristic functions}
  \item
    \hyperref[p4-reproducing-kernel-hilbert-spaces-rkhs]{P4. Reproducing
    kernel Hilbert spaces (RKHS)}
  \item
    \hyperref[p5-u-statistics-and-v-statistics]{P5. U-statistics and
    V-statistics}
  \item
    \hyperref[p6-bootstrap-permutation-jackknife]{P6. Bootstrap,
    permutation, jackknife}
  \item
    \hyperref[p7-copulas]{P7. Copulas}
  \item
    \hyperref[p8-granger-causality-and-dags]{P8. Granger causality and
    DAGs}
  \item
    \hyperref[p9-shapley-values-from-cooperative-game-theory]{P9.
    Shapley values from cooperative game theory}
  \end{itemize}
\item
  \hyperref[the-five-properties-that-distinguish-dependence-measures]{The
  Five Properties That Distinguish Dependence Measures}
\item
  \hyperref[master-comparison-table]{Master Comparison Table}
\item
  \hyperref[part-i--classical-and-rank-correlation-coefficients]{Part I
  --- Classical and Rank Correlation Coefficients}

  \begin{itemize}
  \tightlist
  \item
    \hyperref[1-pearsons-productmoment-correlation-r]{1.
    Pearson\textquotesingle s Product--Moment Correlation \(r\)}
  \item
    \hyperref[2-spearmans-rank-correlation-rho]{2.
    Spearman\textquotesingle s Rank Correlation \(\rho\)}
  \item
    \hyperref[3-kendalls-tau]{3. Kendall\textquotesingle s \(\tau\)}
  \item
    \hyperref[4-point-biserial-correlation-r_pb]{4. Point-Biserial
    Correlation \(r_{pb}\)}
  \item
    \hyperref[5-the-phi-coefficient-phi]{5. The Phi Coefficient
    \(\phi\)}
  \item
    \hyperref[6-cramers-v]{6. Cramér\textquotesingle s \(V\)}
  \item
    \hyperref[7-tetrachoric-and-polychoric-correlation]{7. Tetrachoric
    and Polychoric Correlation}
  \end{itemize}
\item
  \hyperref[part-ii--information-theoretic-dependence]{Part II ---
  Information-Theoretic Dependence}

  \begin{itemize}
  \tightlist
  \item
    \hyperref[8-mutual-information-mi]{8. Mutual Information (MI)}
  \item
    \hyperref[9-maximal-information-coefficient-mic]{9. Maximal
    Information Coefficient (MIC)}
  \item
    \hyperref[10-normalized-mutual-information-nmi]{10. Normalized
    Mutual Information (NMI)}
  \item
    \hyperref[11-transfer-entropy]{11. Transfer Entropy}
  \item
    \hyperref[12-conditional-mutual-information-cmi]{12. Conditional
    Mutual Information (CMI)}
  \end{itemize}
\item
  \hyperref[part-iii--geometric-kernel-and-modern-independence-measures]{Part
  III --- Geometric, Kernel, and Modern Independence Measures}

  \begin{itemize}
  \tightlist
  \item
    \hyperref[13-distance-correlation-dcor]{13. Distance Correlation
    (dCor)}
  \item
    \hyperref[14-brownian-covariance]{14. Brownian Covariance}
  \item
    \hyperref[15-kernel-canonical-correlation-analysis-kcca]{15. Kernel
    Canonical Correlation Analysis (KCCA)}
  \item
    \hyperref[16-hilbertschmidt-independence-criterion-hsic]{16.
    Hilbert--Schmidt Independence Criterion (HSIC)}
  \item
    \hyperref[17-chatterjees-rank-correlation-xi]{17.
    Chatterjee\textquotesingle s Rank Correlation \(\xi\)}
  \end{itemize}
\item
  \hyperref[part-iv--model-agnostic-feature-importance]{Part IV ---
  Model-Agnostic Feature Importance}

  \begin{itemize}
  \tightlist
  \item
    \hyperref[18-shap-shapley-additive-explanations]{18. SHAP (SHapley
    Additive exPlanations)}
  \item
    \hyperref[19-permutation-feature-importance-pfi]{19. Permutation
    Feature Importance (PFI)}
  \item
    \hyperref[20-lime-local-interpretable-model-agnostic-explanations]{20.
    LIME (Local Interpretable Model-agnostic Explanations)}
  \item
    \hyperref[21-partial-dependence-pdp-and-individual-conditional-expectation-ice]{21.
    Partial Dependence (PDP) and Individual Conditional Expectation
    (ICE)}
  \end{itemize}
\item
  \hyperref[part-v--tree-specific-and-embedded-metrics]{Part V ---
  Tree-Specific and Embedded Metrics}

  \begin{itemize}
  \tightlist
  \item
    \hyperref[22-gini-importance--mean-decrease-in-impurity-mdi]{22.
    Gini Importance / Mean Decrease in Impurity (MDI)}
  \item
    \hyperref[23-mean-decrease-in-accuracy-mda]{23. Mean Decrease in
    Accuracy (MDA)}
  \item
    \hyperref[24-gain-split-and-cover-importance-in-boosted-trees]{24.
    Gain, Split, and Cover Importance in Boosted Trees}
  \item
    \hyperref[25-lasso-and-ridge-coefficients-as-importance]{25. LASSO
    and Ridge Coefficients as Importance}
  \end{itemize}
\item
  \hyperref[cross-cutting-themes]{Cross-Cutting Themes}
\item
  \hyperref[common-confusions-and-how-to-resolve-them]{Common Confusions
  and How to Resolve Them}
\item
  \hyperref[glossary]{Glossary}
\item
  \hyperref[appendix-a--reference-implementations-and-libraries]{Appendix
  A --- Reference Implementations and Libraries}
\item
  \hyperref[appendix-b--a-complete-numerical-walkthrough-with-code]{Appendix
  B --- A Complete Numerical Walkthrough with Code}
\item
  \hyperref[appendix-c--annotated-bibliography]{Appendix C --- Annotated
  Bibliography}
\end{itemize}
